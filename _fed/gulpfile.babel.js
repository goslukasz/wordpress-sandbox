...
function cleanStyles () {
  return del([
    globalConfig.outputPath + globalConfig.outputFolders.styles + '**/*.css',
    '!' + globalConfig.outputPath + globalConfig.outputFolders.styles + 'custom.css', // Drupal 8 (TheMag)
    '!' + globalConfig.outputPath + globalConfig.outputFolders.styles + 'subtheme.css' // Drupal 8 (TheMag)
  ], {force: true});
}
...
function cleanScripts () {
  return del([
    ...
    '!' + globalConfig.outputPath + globalConfig.outputFolders.scripts + 'custom.js' // Drupal 8 (TheMag)
  ], {force: true});
}
...
function style () {
  return gulp.src(globalConfig.assetsToLoad.styles)
    ...
    .pipe($.sass.sync({
      outputStyle: $.if(DIST, 'expanded', 'compressed'),
